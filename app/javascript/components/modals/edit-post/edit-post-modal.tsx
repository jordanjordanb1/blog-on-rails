...
interface EditPostProps {
  ...
  handleClose: MouseEventHandler | (() => void)
}

const EditPost = memo<EditPostProps>(
  ({ open, post: originalPost, handleClose }) => {
    const { execute, loading, error } = useUpdatePost<
    ...
    const titleIsTouched = post.title !== originalPost.title
    const bodyIsTouched = post.body !== originalPost.body
